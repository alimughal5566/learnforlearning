...
<!-- Card -->
    ...
    <section id="course-part" class="pt-115 pb-115 bg_cover gray-bg" style="background-image: url(images/course/course-shape.png)"> <section id="course-part" class="pt-115 pb-115 bg_cover gray-bg" style="background-image: url(images/course/course-shape.png)">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="level-heading-courses">My Schedule</h3>
                </div>
            </div> <!-- row -->
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="single-course-2 mt-30">
                        <div class="thum">
                            <div class="image">
                                <a href="{{route('studentLesson',[$schedule->id])}}"> <img src="{{asset('asset/images/course/cu-1.jpg')}}" alt="Course"></a>
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher d-flex align-items-center">
                                <div class="thum">
                                    <a href="courses-single.html"><img src="{{url('/storage/images/'.$schedule->teacher_thumbnail)}}" alt="teacher"></a>
                                </div>
                                <div class="teacher ml-10">
                                    <div class="name">
                                        <a href="#"><h6>{{$schedule->teacher_fname}}-{{$schedule->teacher_lname}}</h6></a>
                                    </div>
                                    <div class="review">
                                        <ul>
